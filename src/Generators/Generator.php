...
abstract class Generator implements GeneratorContract
{
    ...
    protected array $creators = [
        \Lenius\LivewireGenerator\Creators\IndexClass::class,
        \Lenius\LivewireGenerator\Creators\IndexView::class,
        \Lenius\LivewireGenerator\Creators\FormClass::class,
        \Lenius\LivewireGenerator\Creators\FormView::class,
        \Lenius\LivewireGenerator\Creators\DetailClass::class,
        \Lenius\LivewireGenerator\Creators\DetailView::class,
    ];
